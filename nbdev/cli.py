...
__all__ = ['nbdev_migrate2magic', 'nbdev_build_lib', 'nbdev_update_lib', 'nbdev_diff_nbs', 'nbdev_test_nbs',
           'make_readme', 'nbdev_build_docs', 'nbdev_nb2md', 'nbdev_detach', 'nbdev_build_docs_from_org',
           'nbdev_read_nbs', 'nbdev_trust_nbs', 'nbdev_fix_merge', 'bump_version', 'nbdev_bump_version',
           'nbdev_install_git_hooks', 'nbdev_new']
...
# Cell
@call_parse
def nbdev_build_docs_from_org():
    scriptpath = str(os.path.dirname(os.path.realpath(__file__))) + "/nbdev_build_docs_from_org.sh"
